...
app.get('/pokemons', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var pokemons, pokemonsList, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, getPokemons()];
            case 1:
                pokemons = _a.sent();
                pokemonsList = pokemons.map(function (pokemon) { return pokemon.name; }).join(', ');
                res.send("Lista de Pok\u00E9mons: ".concat(pokemonsList));
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
